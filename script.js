...
document.addEventListener('DOMContentLoaded', () => {
  ...
  /* ==================================================
     SINGLE-STEP LOGIN / SIGNUP
     One form (full name, admission number, department,
     email, password) doubles as both login and account
     creation. On success the student is redirected to the
     standalone dashboard.html — the portal never lives on
     this page.
     ================================================== */
  ...
  if (!isSupabaseConfigured) {
    accessHint.textContent = 'Demo mode — Supabase isn\'t connected yet, any details work.';
  } else {
    accessHint.textContent = 'Connected to Supabase — first-time details create your profile automatically.';
  }
  ...
  if (isSupabaseConfigured) {
    ...
    accessForm.addEventListener('submit', async (e) => {
      ...
      const reg = document.getElementById('accessReg').value.trim();
      const dept = document.getElementById('accessDept').value.trim();
      const email = document.getElementById('accessEmail').value.trim();
      const password = document.getElementById('accessPassword').value;

      // Try signing in first — covers returning students.
      ...
      // No matching account (or wrong password on a first attempt) — create one.
    ...
    accessForm.addEventListener('submit', (e) => {
      e.preventDefault();
      const name = document.getElementById('accessName').value.trim() || 'Student';
